    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('ET', 'Electronics'), ('FS', 'Fashion'), ('HM', 'Home'), ('SP', 'Sport'), ('TY', 'Toy'), ('AU', 'Auto')], default='HM', max_length=2, null=True)),
